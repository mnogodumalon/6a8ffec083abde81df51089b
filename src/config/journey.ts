 ...
 *   - kursverwaltung: no date pair, no references
 *   - mitgliederverwaltung: date pairs mitgliedschaft_von+mitgliedschaft_bis · lookups beitragsart[foerdermitglied|jugendmitglied|ehrenmitglied|familienmitglied|vollmitglied]
 *   - mitglieder_kursanmeldung: applookups mitglied→mitgliederverwaltung, kurs→kursverwaltung
 *   - kursanmeldung_fuer_interessenten: applookups kurs→kursverwaltung
 */
