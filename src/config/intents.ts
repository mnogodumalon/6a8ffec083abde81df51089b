...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/mitglied-kurs-anmelden', label: { de: 'Kursanmeldung', en: 'Course registration' }, icon: IconUserPlus, description: 'Mitglied in 3 Schritten für einen Kurs anmelden' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-04T13:21:29+00:00';
