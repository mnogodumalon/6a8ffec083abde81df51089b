...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "Vereinsverwaltung & Kursanmeldung",
    "apps": {
      "kursverwaltung": {
        "name": "Kursverwaltung",
        "app_id": "6a8ffd8f3c521d7f844024a3",
        "fields": {
          "kursname": "Kursname",
          "beschreibung": "Beschreibung",
          "kursdatum": "Kursdatum und Uhrzeit",
      ...
      "mitgliederverwaltung": {
        ...
        "app_id": "6a8ffd927dd69a8d9165d82d",
        "fields": {
          "vorname": "Vorname",
          "nachname": "Nachname",
          ...
          "mitgliedschaft_von": "Mitgliedschaft gültig von",
          "mitgliedschaft_bis": "Mitgliedschaft gültig bis",
          "bemerkungen": "Bemerkungen"
        },
        "lookups": {
          "beitragsart": {
            "foerdermitglied": "Fördermitglied",
            "jugendmitglied": "Jugendmitglied",
      ...
      "mitglieder_kursanmeldung": {
        "name": "Mitglieder-Kursanmeldung",
        "app_id": "6a8ffd932ea90c3303c5e8ae",
        "fields": {
          "mitglied": "Mitglied",
          "kurs": "Kurs",
      ...
      "kursanmeldung_fuer_interessenten": {
        "name": "Kursanmeldung für Interessenten",
        "app_id": "6a8ffd93524c819c1820f8e3",
        "fields": {
          "kurs": "Kurs",
          "vorname": "Vorname",
          "nachname": "Nachname",
  ...
  "en": {
    "appgroup": "Club Management & Course Registration",
    "apps": {
      "kursverwaltung": {
        ...
        "fields": {
          ...
          "kursdatum": "Course Date and Time",
          "ort": "Venue",
      ...
      "mitgliederverwaltung": {
        ...
        "fields": {
          ...
          "ort": "City",
          "beitragsart": "Membership Type",
          "mitgliedschaft_von": "Membership Valid From",
          "mitgliedschaft_bis": "Membership Valid To",
          "bemerkungen": "Remarks"
        },
        "lookups": {
          "beitragsart": {
            "foerdermitglied": "Supporting Member",
            "jugendmitglied": "Junior Member",
      ...
      "mitglieder_kursanmeldung": {
        "name": "Member Course Registration",
        "app_id": "6a8ffd932ea90c3303c5e8ae",
        "fields": {
          "mitglied": "Member",
          "kurs": "Course",
      ...
      "kursanmeldung_fuer_interessenten": {
        "name": "Course Registration for Non-Members",
        "app_id": "6a8ffd93524c819c1820f8e3",
        "fields": {
          "kurs": "Course",
          "vorname": "First Name",
